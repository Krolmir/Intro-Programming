...
# number is the sum of the two previous numbers: the 3rd Fibonacci number is 1
# + 1 = 2, the 4th is 1 + 2 = 3, the 5th is 2 + 3 = 5, and so on. In
# mathematical terms:
...
#   n + sum(n - 1)
# end
# sum is a recursive method that computes the sum of all integers between
# 1 and n.
...
# to stop recursing; and, n + sum(n - 1) uses the return value of the recursive
